    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">身份(1-游客，2-骑手，3-合伙人)：</text></view>
                  <input type="number" placeholder="请输入身份(1-游客，2-骑手，3-合伙人)" v-model="model.identity"/>
                </view>
              </view>
				<view class="padding">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/base/riderCustomer/queryById",
                  add: "/base/riderCustomer/add",
                  edit: "/base/riderCustomer/edit",
                },
            }
        },
        created(){
