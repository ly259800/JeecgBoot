...
@Slf4j
public class AiQuestionController extends JeecgController<AiQuestion, IAiQuestionService> {
	@Autowired
	...
	public Result<String> add(@RequestBody AiQuestion aiQuestion) {
		aiQuestionService.save(aiQuestion);
	...
	public Result<String> edit(@RequestBody AiQuestion aiQuestion) {
		aiQuestionService.updateById(aiQuestion);
	...
	public Result<String> delete(@RequestParam(name="id",required=true) String id) {
		aiQuestionService.removeById(id);
	...
	public Result<String> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
		this.aiQuestionService.removeByIds(Arrays.asList(ids.split(",")));
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, AiQuestion aiQuestion) {
        return super.exportXls(request, aiQuestion, AiQuestion.class, "问题");
    }
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        return super.importExcel(request, response, AiQuestion.class);
    }
