package org.jeecg.modules.rider.qrcode.entity;
 ...
 */
@Data
@TableName("rider_qrcode")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="rider_qrcode对象", description="小程序二维码")
public class RiderQrcode implements Serializable {
