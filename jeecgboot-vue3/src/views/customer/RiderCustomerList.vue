     ...
     <!--插槽:table标题-->
      <template #tableTitle>
          ...
          <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'customer:rider_customer:deleteBatch'">批量操作
...
<script lang="ts" name="customer-riderCustomer" setup>
       ...
       return [
         {
           ...
           auth: 'customer:rider_customer:edit'
         }
       ]
   }
     /**
       ...
       return [
         {
           ...
           auth: 'customer:rider_customer:delete'
         }
       ]
   }
