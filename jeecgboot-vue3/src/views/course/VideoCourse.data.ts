...
export const superQuerySchema = {
  ...
  payType: {title: '付费类型',order: 2,view: 'number', type: 'number',dictCode: 'pay_type',},
  price: {title: '付费价格',order: 3,view: 'number', type: 'number',},
  url: {title: '视频链接',order: 4,view: 'file', type: 'string',},
