package org.jeecg.modules.rider.base.controller;
...
import org.jeecg.modules.rider.base.entity.RiderCustomer;
import org.jeecg.modules.rider.base.service.IRiderCustomerService;
...
@Api(tags="客户管理")
@RestController
@RequestMapping("/base/riderCustomer")
@Slf4j
public class RiderCustomerController extends JeecgController<RiderCustomer, IRiderCustomerService> {
	...
	@RequiresPermissions("base:rider_customer:add")
	...
	@RequiresPermissions("base:rider_customer:edit")
	...
	@RequiresPermissions("base:rider_customer:delete")
	...
	@RequiresPermissions("base:rider_customer:deleteBatch")
    ...
    * @param riderCustomer
    */
    @RequiresPermissions("base:rider_customer:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("base:rider_customer:importExcel")
