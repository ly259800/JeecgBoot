package org.jeecg.modules.rider.wechat.controller;
...
public class WxLoginController {
    ...
    public Result userLogin(HttpServletRequest request, @RequestBody WxLoginDTO login) {
        ...
        //token 信息
        obj.put("token", token);
        RiderCustomerDTO riderCustomerDTO = riderCustomerService.convertTotal(userDTO);
        obj.put("userInfo", riderCustomerDTO);
        result.setData(obj);
        result.setCode(200);
