    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">身份：</text></view>
                  <input type="number" placeholder="请输入身份" v-model="model.identity"/>
                </view>
              </view>
				<view class="padding">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/customer/riderCustomer/queryById",
                  add: "/customer/riderCustomer/add",
