...
<script lang="ts">
  ...
  import {getBpmFormSchema,aiOptionColumns} from '../AiQuestion.data';
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      const queryByIdUrl = '/question/aiQuestion/queryById';
      async function initFormData(){
        let params = {id: props.formData.dataId};
        const data = await defHttp.get({url: queryByIdUrl, params});
        //设置表单的值
        await setFieldsValue({...data});
        requestSubTableData(aiOptionList, {id: data.id}, aiOptionTable, ()=>{
          aiOptionTable.show = true;
        });
        //默认是禁用
